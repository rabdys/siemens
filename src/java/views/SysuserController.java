...
public class SysuserController implements Serializable {
    ...
    @EJB
    private models.SysuserFacade ejbFacade;
    ...
    private SysuserFacade getFacade() {
        return ejbFacade;
    }
    ...
    public Sysuser getSysuser(java.lang.String id) {
    ...
    public static class SysuserControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getSysuser(getKey(value));
        }
